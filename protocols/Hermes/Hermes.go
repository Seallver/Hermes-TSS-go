...
import (
	...
	"github.com/taurusgroup/multi-party-sig/protocols/Hermes/keygen"
	//"github.com/taurusgroup/multi-party-sig/protocols/Hermes/presign"
	"github.com/taurusgroup/multi-party-sig/protocols/Hermes/sign"
)
...
func Refresh(config *Config, pl *pool.Pool) protocol.StartFunc {
	info := round.Info{
		ProtocolID:       "Hermes/refresh-threshold",
		FinalRoundNumber: keygen.Rounds,
		SelfID:           config.ID,
